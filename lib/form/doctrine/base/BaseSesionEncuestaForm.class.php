...
/**
 * SesionEncuesta form base class.
 *
 * @method SesionEncuesta getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseSesionEncuestaForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fecha_inicio_sesion' => new sfWidgetFormDateTime(),
    ...
    $this->setValidators(array(
      ...
      'fecha_inicio_sesion' => new sfValidatorDateTime(),
      'created_at'          => new sfValidatorDateTime(),
      'updated_at'          => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('sesion_encuesta[%s]');
