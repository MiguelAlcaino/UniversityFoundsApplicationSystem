...
/**
 * ArchivoRecurso form base class.
 *
 * @method ArchivoRecurso getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseArchivoRecursoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archivo_recurso[%s]');
