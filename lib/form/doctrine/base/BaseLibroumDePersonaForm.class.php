...
/**
 * LibroumDePersona form base class.
 *
 * @method LibroumDePersona getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseLibroumDePersonaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libroum_de_persona[%s]');
