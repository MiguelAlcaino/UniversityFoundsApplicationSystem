...
/**
 * LibDePersona form base class.
 *
 * @method LibDePersona getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseLibDePersonaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lib_de_persona[%s]');
