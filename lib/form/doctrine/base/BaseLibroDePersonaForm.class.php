...
/**
 * LibroDePersona form base class.
 *
 * @method LibroDePersona getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseLibroDePersonaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libro_de_persona[%s]');
