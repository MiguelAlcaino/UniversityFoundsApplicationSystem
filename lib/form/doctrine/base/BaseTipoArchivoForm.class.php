...
/**
 * TipoArchivo form base class.
 *
 * @method TipoArchivo getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseTipoArchivoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'               => new sfWidgetFormInputHidden(),
      'nombre_documento' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'nombre_documento' => new sfValidatorString(array('max_length' => 255)),
      'acronimo'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'created_at'       => new sfValidatorDateTime(),
      'updated_at'       => new sfValidatorDateTime(),
      'concursos_list'   => new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'Concurso', 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('tipo_archivo[%s]');
