...
/**
 * NotaProductividad filter form base class.
 *
 ...
 */
abstract class BaseNotaProductividadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'porcentaje_productividad_concurso_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('PorcentajeProductividadConcurso'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('nota_productividad_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'porcentaje_productividad_concurso_id' => 'ForeignKey',
      'nota'                                 => 'Number',
      'created_at'                           => 'Date',
      'updated_at'                           => 'Date',
    );
