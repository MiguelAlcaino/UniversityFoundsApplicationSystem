...
/**
 * RestriccionConcurso filter form base class.
 *
 ...
 */
abstract class BaseRestriccionConcursoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('restriccion_concurso_filters[%s]');
