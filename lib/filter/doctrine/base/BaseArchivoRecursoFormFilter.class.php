...
/**
 * ArchivoRecurso filter form base class.
 *
 ...
 */
abstract class BaseArchivoRecursoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('archivo_recurso_filters[%s]');
