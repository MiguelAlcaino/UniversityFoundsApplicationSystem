...
/**
 * LibDePersona filter form base class.
 *
 ...
 */
abstract class BaseLibDePersonaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lib_de_persona_filters[%s]');
