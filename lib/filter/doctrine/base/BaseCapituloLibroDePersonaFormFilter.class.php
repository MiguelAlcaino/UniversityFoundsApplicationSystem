...
/**
 * CapituloLibroDePersona filter form base class.
 *
 ...
 */
abstract class BaseCapituloLibroDePersonaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'persona_id'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Persona'), 'add_empty' => true)),
      'nombre_libro'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'nombre_capitulo' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'nombre_libro'    => new sfValidatorPass(array('required' => false)),
      'nombre_capitulo' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('capitulo_libro_de_persona_filters[%s]');
