...
/**
 * LibroumDePersona filter form base class.
 *
 ...
 */
abstract class BaseLibroumDePersonaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libroum_de_persona_filters[%s]');
