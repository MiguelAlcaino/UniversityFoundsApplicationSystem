...
/**
 * LibroDePersona filter form base class.
 *
 ...
 */
abstract class BaseLibroDePersonaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('libro_de_persona_filters[%s]');
