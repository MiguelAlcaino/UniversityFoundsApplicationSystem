...
/**
 * DetalleRecurso filter form base class.
 *
 ...
 */
abstract class BaseDetalleRecursoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('detalle_recurso_filters[%s]');
