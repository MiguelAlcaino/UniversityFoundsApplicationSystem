...
<tr>
<td colspan="3">
<div class="archivos_patrones"> Formato: <?php echo link_to(image_tag('word.gif').'Documento Word', public_path('archivo_patron/di_tesis/Gastos_operacion _Tesis_doctoral.doc')) ?> </div>
<br />
