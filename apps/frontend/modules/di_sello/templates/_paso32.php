...
<tr>
  ...
  <td><?php echo $form['recursos']['gastos_operacion']['detalles_recurso']['detalle_recurso_1']['detalles_gastos_operacion']['detalle_recurso_gasto_operacion_4']['monto']?>
  <?php echo $form['recursos']['gastos_operacion']['detalles_recurso']['detalle_recurso_1']['detalles_gastos_operacion']['detalle_recurso_gasto_operacion_4']->renderHiddenFields(false)?></td>
  <td><?php echo $form['recursos']['gastos_operacion']['detalles_recurso']['detalle_recurso_2']['detalles_gastos_operacion']['detalle_recurso_gasto_operacion_4']['monto']?>
  <?php echo $form['recursos']['gastos_operacion']['detalles_recurso']['detalle_recurso_2']['detalles_gastos_operacion']['detalle_recurso_gasto_operacion_4']->renderHiddenFields(false)?>
  </td>
</tr>
...
<tr>
<td colspan="3">
<div class="archivos_patrones"> Formato: <?php echo link_to(image_tag('word.gif').'Documento Word', public_path('archivo_patron/di_sello/Gastos_operacion_sello_valorico.doc')) ?> </div>
<br />
