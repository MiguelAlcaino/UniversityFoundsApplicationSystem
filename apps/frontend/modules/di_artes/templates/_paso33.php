...
<tr>
<td colspan="3">
<div class="archivos_patrones"> Formato: <?php echo link_to(image_tag('word.gif').'Documento Word', public_path('archivo_patron/di_artes/Alumno_ayudante_creacion_artistica.doc')) ?> </div>
<br />
...
<tr>
<td colspan="3">
<div class="archivos_patrones"> Formato: <?php echo link_to(image_tag('word.gif').'Documento Word', public_path('archivo_patron/di_artes/Personal_tecnico_creacion_artistica.doc')) ?> </div>
<br />
