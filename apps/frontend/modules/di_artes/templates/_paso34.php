<fieldset>
<legend>Viajes y vi&aacute;ticos</legend>
...
<tr>
<td colspan="3">
<div class="archivos_patrones"> Formato: <?php echo link_to(image_tag('word.gif').'Documento Word', public_path('archivo_patron/di_artes/Viajes_creacion_artistica.doc')) ?> </div>
<br />
